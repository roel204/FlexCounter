    ...
    return (
        <div className="flex flex-row gap-4 w-[854px] h-[25vh] justify-between">
            <div className="w-[30%] bg-black/25 rounded-2xl p-4 ">
                <button className="absolute w-8" onClick={saveScore}>
                ...
                <p className="text-5xl text-center">Left</p>
                <p className="text-9xl text-center">{lScore}</p>
            </div>
            <div className="flex flex-col justify-between w-[40%] items-center">
                <div className="w-full h-full bg-black/25 rounded-2xl p-4 mb-2">
                    <button className="absolute w-8" onClick={resetTotal}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="fill-orange-200 hover:fill-orange-400">
                            <path
                    ...
                    <p className="text-4xl text-center">{lTotal} + {rTotal}</p>
                </div>
                <div className="w-full h-full bg-black/25 rounded-2xl p-4">
                    <button className="absolute w-8" onClick={resetRecord}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="fill-orange-200 hover:fill-orange-400">
                            <path
                                d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"/>
                        </svg>
                    </button>
                    <p className="text-3xl text-center">Record</p>
                    <p className="text-4xl text-center">{lRecord} + {rRecord}</p>
                </div>
            </div>
